        ...
        <form class="pure-form pure-form-stacked">
          <fieldset>
            <legend ><b>搜尋條件</b></legend>
              ...
              <br>
              <label><b>運動類型</b></label>
              <label for="option-one" class="pure-checkbox">
                  <input id="option-running" type="checkbox"> 跑步
                  <input id="option-basketball" type="checkbox"> 籃球
                  <input id="option-badminton" type="checkbox"> 羽球
              </label>
              <label for="option-one" class="pure-checkbox">
                  <input id="option-baseball" type="checkbox"> 棒球
                  <input id="option-volleyball" type="checkbox"> 排球
                  <input id="option-tennis" type="checkbox"> 網球
              </label>
              <br>
              <button onclick="searchArea()" type="button" class="pure-button pure-button-primary">搜尋</button>
          </fieldset>
        </form>
